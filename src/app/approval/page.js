  ...
  <div className="max-w-7xl mx-auto space-y-6">
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
      ...
      <div className="lg:col-span-8 flex flex-col justify-between">
        <div className="relative overflow-hidden p-8 rounded-2xl text-white shadow-sm h-full flex flex-col justify-center min-h-[200px] border border-white/20">
      ...
      {requests.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {requests.map((req, index) => (
            <div
              key={req.id || index}
              className="bg-white/90 backdrop-blur-md p-5 rounded-2xl border border-white/50 shadow-sm flex flex-col justify-between space-y-3"
            >
              <div>
